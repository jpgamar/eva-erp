        ...
        "content": [
            ...
            },
            {
                ...
                "value": (
                    ...
                    "style=\"margin:0 auto 12px auto;\"><tr>"
                    "<td style=\"width:6px;height:16px;border-radius:3px;background:#60a5fa;opacity:0.9;\"></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;height:28px;border-radius:3px;background:#3b82f6;\"></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;height:40px;border-radius:3px;background:#2563eb;\"></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;height:28px;border-radius:3px;background:#3b82f6;\"></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;height:16px;border-radius:3px;background:#60a5fa;opacity:0.9;\"></td>"
