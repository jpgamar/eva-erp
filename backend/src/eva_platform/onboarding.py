        ...
        "content": [
            ...
            },
            {
                ...
                "value": (
                    ...
                    "<tr><td style=\"padding:24px 28px 6px 28px;text-align:center;\">"
                    "<table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" "
                    "style=\"margin:0 auto 10px auto;\"><tr style=\"height:40px;\">"
                    "<td style=\"width:6px;vertical-align:bottom;\"><div style=\"width:6px;height:16px;border-radius:3px;background:#60a5fa;\"></div></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;vertical-align:bottom;\"><div style=\"width:6px;height:28px;border-radius:3px;background:#3b82f6;\"></div></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;vertical-align:bottom;\"><div style=\"width:6px;height:40px;border-radius:3px;background:#2563eb;\"></div></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;vertical-align:bottom;\"><div style=\"width:6px;height:28px;border-radius:3px;background:#3b82f6;\"></div></td>"
                    "<td style=\"width:4px;\"></td>"
                    "<td style=\"width:6px;vertical-align:bottom;\"><div style=\"width:6px;height:16px;border-radius:3px;background:#60a5fa;\"></div></td>"
                    "</tr></table>"
                    "<div style=\"font-size:15px;line-height:1;color:#2563eb;font-weight:700;margin-bottom:10px;\">Eva AI</div>"
                    f"<div style=\"font-size:42px;line-height:1.2;color:#0f172a;font-weight:700;\">Hola {display_name}</div>"
                    "</td></tr>"
                    ...
                    "<p style=\"margin:0;color:#334155;font-size:17px;line-height:1.55;\">"
