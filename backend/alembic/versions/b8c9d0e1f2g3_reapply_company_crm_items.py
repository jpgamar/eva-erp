"""re-apply empresa_items CRM todo and calendar fields after revert

Chains after ``a6b7c8d9e0f1_revert_company_crm_items`` so production rolls
forward through the revert and re-applies the columns idempotently. The
historical ``z5a6b7c8d9e0`` migration is preserved verbatim per plan rules.
