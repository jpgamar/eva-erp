...
const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  "/proveedores": { title: "Proveedores", subtitle: "Gestion de proveedores" },
  "/pagos": { title: "Pagos", subtitle: "Anticipos, pagos directos y tipo de cambio" },
  "/facturas-proveedor": { title: "Facturas Proveedor", subtitle: "Facturas de proveedores" },
  "/diferencias-cambiarias": { title: "Diferencias Cambiarias", subtitle: "Ganancias y perdidas por tipo de cambio" },
