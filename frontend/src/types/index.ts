...
export interface PagoAplicacion {
  ...
  base_amount_at_pago_rate: number;
  base_amount_at_document_rate: number;
  exchange_difference_mxn: number;
  applied_at: string;
}
...
export interface PagoProveedorSummary {
  ...
  total_pendiente_mxn: number;
  total_aplicado_usd: number;
  total_aplicado_mxn: number;
  total_diferencia_cambiaria_mxn: number;
...
export interface DiferenciaCambiaria {
  ...
  gain_loss_mxn: number;
  period: string;
  created_at: string;
}

export interface DiferenciaCambiariaSummary {
  total_gain_mxn: number;
  total_loss_mxn: number;
  net_mxn: number;
  count: number;
